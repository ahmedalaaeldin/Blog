      ...
      <div class="row justify-content-center">
          ...
          <div class="col-md-8">
              ...
              <div class="card">
                  ...
                  <div class="card-header" style="text-align:center;background-color:white">Register Form</div>
                  ...
                  <div class="card-body">
                      ...
                      <form action="{{ route('register.post') }}" method="POST">
                          ...
                          <div class="form-group row">
                              ...
                              <label for="email_address" class="col-md-4 col-form-label text-md-right">Your Address</label>
                          ...
                          <a class="nav-link" href="{{ route('login') }}">Login Now</a>
                      </form>
